			...
			<div class="menu-content p-a">
				<div class="details-list" id="tab">
					...
					<ul id="flower4">
						...
						<li class="details-item diamonds">
							<a href="javascript:;">
								<img src="../img/m_category_cake_ganso.jpg"/>
							</a>
						</li>
						<li class="details-item diamonds">
							<a href="javascript:;">
...
.classify-menu>ul>li:first-child{
	margin-top:0 ;
	padding-top:10px ;
}
.menu-content{
...
.details-list>ul>a{
	...
	height: 6.6rem;
	margin-bottom:1rem; 
    background: url(/img/18_shizizuo_m.4bd04ce7.jpg) no-repeat;
